...
<div class='admin-accounts'>
    ...
    <div class='details'>
        ...
        <div class='iframe-nav-projectContribution'>
            <div class='contribution-iframe-link fontColorChange' target='iframe-2' id='contributions' onclick="fontColorChanger()">Contributions</div>
            <div class='contribution-iframe-link' target='iframe-2' id='involved-projects' onclick="fontColorChangerProjects()">Projects</div>
        </div>
