...
<!--                $('#registered-account').hide();-->
<!--            });-->
<!--            $('#account-registered').click(() => {-->
    ...
    <div class='admin-accounts'>
        <div class='admin-account-iframe'>
            <div class='iframe-nav'>
                <a class='iframe-nav-link' id='account-signup'
                   onclick="onClickState('account-signup'); onClickPageShow('account-signup')">Create</a>
                <a class='iframe-nav-link iframe-nav-state' id='account-request'
                   onclick="onClickState('account-request'); onClickPageShow('account-request')">Requests</a>
                <a class='iframe-nav-link' id='account-rejected' target='iframe'
                   onclick="onClickState('account-rejected'); onClickPageShow('account-rejected')">Rejected</a>
                <a class='iframe-nav-link' id='account-registered' target='iframe'
                   onclick="onClickState('account-registered'); onClickPageShow('account-registered')">Registered</a>
                <a class='iframe-nav-link' id='account-banned' target='iframe'
                   onclick="onClickState('account-banned'); onClickPageShow('account-banned')">Banned</a>
            </div>
            ...
            <div class='iframe-display'>
                ...
                <div class='card rejected-requests' id='rejected-request'>
                    ...
                    <div class='results'>
                        <div class='result' onmouseover="DisplayButtons('rej-req-1')"
                             onmouseout="HideButtons('rej-req-1')">
                        ...
                        <div class='result' onmouseover="DisplayButtons('rej-req-2')"
                             onmouseout="HideButtons('rej-req-2')">
                        ...
                        <div class='result' onmouseover="DisplayButtons('rej-req-3')"
                             onmouseout="HideButtons('rej-req-3')">
                        ...
                        <div class='result' onmouseover="DisplayButtons('rej-req-4')"
                             onmouseout="HideButtons('rej-req-4')">
                        ...
                        <div class='result' onmouseover="DisplayButtons('rej-req-5')"
                             onmouseout="HideButtons('rej-req-5')">
                        ...
                        <div class='result' onmouseover="DisplayButtons('rej-req-6')"
                             onmouseout="HideButtons('rej-req-6')">
                        ...
                        <div class='result' onmouseover="DisplayButtons('rej-req-7')"
                             onmouseout="HideButtons('rej-req-7')">
                        ...
                        <div class='result' onmouseover="DisplayButtons('rej-req-8')"
                             onmouseout="HideButtons('rej-req-8')">
                        ...
                        <div class='result' onmouseover="DisplayButtons('rej-req-9')"
                             onmouseout="HideButtons('rej-req-9')">
                ...
                <div class='card account-requests' id='requests-account'>
                    ...
                    <div class='results'>
                        <div class='result' onmouseover="DisplayButtons('acc-req-1')"
                             onmouseout="HideButtons('acc-req-1')">
                            <p class='request-id'>RequestID 1</p>
                            <div class='buttons' id='acc-req-1'>
                                <button class='view-btn btn'>View</button>
                            </div>
                        </div>
                        <div class='result' onmouseover="DisplayButtons('acc-req-2')"
                             onmouseout="HideButtons('acc-req-2')">
                            <p class='request-id'>RequestID 2</p>
                            <div class='buttons' id='acc-req-2'>
                                <button class='view-btn btn'>View</button>
                            </div>
                        </div>
                        <div class='result' onmouseover="DisplayButtons('acc-req-3')"
                             onmouseout="HideButtons('acc-req-3')">
                            <p class='request-id'>RequestID 3</p>
                            <div class='buttons' id='acc-req-3'>
                                <button class='view-btn btn' id='acc-req-3'>View</button>
                            </div>
                        </div>
                        <div class='result' onmouseover="DisplayButtons('acc-req-4')"
                             onmouseout="HideButtons('acc-req-4')">
                            <p class='request-id'>RequestID 4</p>
                            <div class='buttons' id='acc-req-4'>
                                <button class='view-btn btn' id='acc-req-4'>View</button>
                            </div>
                        </div>
                        <div class='result' onmouseover="DisplayButtons('acc-req-5')"
                             onmouseout="HideButtons('acc-req-5')">
                            <p class='request-id'>RequestID 5</p>
                            <div class='buttons' id='acc-req-5'>
                                <button class='view-btn btn' id='acc-req-5'>View</button>
                            </div>
                        </div>
                        <div class='result' onmouseover="DisplayButtons('acc-req-6')"
                             onmouseout="HideButtons('acc-req-6')">
                            <p class='request-id'>RequestID 6</p>
                            <div class='buttons' id='acc-req-6'>
                                <button class='view-btn btn' id='acc-req-6'>View</button>
                            </div>
                        </div>
                        <div class='result' onmouseover="DisplayButtons('acc-req-7')"
                             onmouseout="HideButtons('acc-req-7')">
                            <p class='request-id'>RequestID 7</p>
        ...
        <div class='details'>
            ...
            <div class='iframe-nav-projectContribution'>
                <a href='./admin-accounts/admin-accounts-contributions.php'
                   class='contribution-iframe-link fontColorChange' target='iframe-2' id='contributions'
                   onclick="fontColorChanger()">Contributions</a>
                <a href='./admin-accounts/admin-accounts-involved-projects.php' class='contribution-iframe-link'
                   target='iframe-2' id='involved-projects' onclick="fontColorChangerProjects()">Projects</a>
            </div>
            <iframe class='iframe-display-projectContribution' src='./admin-accounts/admin-accounts-contributions.php'
                    name='iframe-2' height='100%' width='100%' title="Iframe">
