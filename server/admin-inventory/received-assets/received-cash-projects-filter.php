...
echo"             </select>
                  ...
                  <div class='col2'>
                      ...
                      <button class='generate-reports-btn btn'
                            onclick=projectsGenReportBtn(document.getElementById('from1').value,document.getElementById('to1').value,document.getElementById('donorName1').value,document.getElementById('donorEmail1').value,document.getElementById('for1').value)
