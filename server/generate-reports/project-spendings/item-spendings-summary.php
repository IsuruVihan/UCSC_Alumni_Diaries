...
$query2 = "SELECT * FROM projectitemspendings WHERE ProjectId = '{$ProjectId}'";
$query3 = "
...
$pdf->Cell(207, 30, 'Project Items Spendings Summary', 0, 0, 'C');
...
while ($row = mysqli_fetch_assoc($results)) {
    ...
    $pdf->Cell(40,10, 'Spent Quantity (Qty)',1,0,'C');
    ...
    if (mysqli_num_rows($results3) > 0) {
        while ($row3 = mysqli_fetch_assoc($results3)) {
            $pdf->Cell(25,10, $row3['ItemId'],1,0,'C');
            $pdf->Cell(80,10, $row3['Description'],1,0,'C');
            $pdf->Cell(50,10, $row3['Timestamp'],1,0,'C');
            $pdf->Cell(40,10, $row3['SpentQuantity'],1,0,'C');
            $pdf->Ln();
...
$query5 = "
    ...
    VALUES ('{$_SESSION['Email']}', 'Admin - Project Spendings', 'Project items spend report generated')
";
