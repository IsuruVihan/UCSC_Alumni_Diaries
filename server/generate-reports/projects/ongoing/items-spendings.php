<?php
    ...
    $pdf->Cell(207, 30, 'Ongoing project items spendings', 0, 0, 'C');
    ...
    $query16 = "
        ...
        VALUES ('{$_SESSION['Email']}', 'Projects - Ongoing', 'Item spent record of Project (ID): {$ProjectId} - Report generated')
    ";
