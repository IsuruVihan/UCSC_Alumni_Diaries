<?php
    ...
    $query = "DELETE FROM projectcashspendings WHERE Id='{$RequestId}'";
    $query2 = "
    ...
    $query10 = "
        ...
        VALUES ('{$_SESSION['Email']}', 'Projects - Ongoing', 'Deleted Cash spend request (ID): {$RequestId} of Project (ID): {$ProjectId}')
    ";
