<?php
    ...
    $query = "
        SELECT Quantity, SpentQuantity, ItemId FROM projectitems INNER JOIN projectitemspendings
        ON projectitems.Id = projectitemspendings.ItemId
        WHERE projectitemspendings.Id = '{$RequestId}'
    ";
    $query4 = "UPDATE projectitemspendings SET Status='Paid' WHERE Id='{$RequestId}'";
    $query2 = "
