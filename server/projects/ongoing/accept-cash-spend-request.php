<?php
    ...
    $query = "UPDATE projectcashspendings SET Status='Accepted' WHERE Id='{$RequestId}'";
    $query2 = "
    ...
    if (mysqli_num_rows($results10) > 0) {
        while ($row10 = mysqli_fetch_assoc($results10)) {  
            ...
            $query16 = "
                ...
                VALUES ('{$_SESSION['Email']}', 'Projects - Ongoing', 'Accepted Cash spend request (ID): {$RequestId} of Project (ID): {$ProjectId}')
            ";
